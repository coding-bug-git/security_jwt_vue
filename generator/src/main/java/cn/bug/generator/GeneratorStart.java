...
public class GeneratorStart {
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://192.168.1.102:3306/security_jwt_vue", "root", "1234")
                .globalConfig(builder -> {
                    builder.author("coding-bug") // 设置作者
